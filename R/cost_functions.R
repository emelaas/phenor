...
#' A (log) likelihood cost function for model optimization with Type II model slope constraint
#'
#' @param par a vector of parameter values, this is functions specific
#' @param data nested data structure with validation data as returned
#' by format_phenocam() or format_pep725(), or your own dataset adhering
...
#' # parameterset par.
#' \dontrun{
#' cost_value = likelihood_slope(par, data, model="TTs")
#' }

likelihood_slope = function(par,
  data,
  model,
  sd_range, ...) {
